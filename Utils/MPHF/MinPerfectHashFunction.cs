...
namespace Utils.MPHF
{
	/// <summary>
	/// Minimum Perfect Hash function class
	/// </summary>
	public class MinPerfectHashFunction
	{
		CompressedSeq _cs;
		...
		public static MinPerfectHashFunction Create(IKeySource keySource, double c)
		{
			...
			var ret = new MinPerfectHashFunction { _hashSeed = hashSeed, _cs = cs, _nbuckets = buckets.NBuckets, _n = buckets.N };
